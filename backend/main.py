...
app.add_middleware(CORSMiddleware, allow_origins=['https://ninjaa.me', 'https://www.ninjaa.me', 'http://localhost:3000', 'http://192.168.10.105:3000', 'https://format-studio.onrender.com'], allow_credentials=True, allow_methods=['*'], allow_headers=['*'])
